...
if (isset($_POST['name'])) {
    ...
    mysqli_query($con, "INSERT INTO `suppliers` (`CompanyName`, `ContactName`, `ContactTitle`, `Address`, `City`, `Region`, 'PostalCode', 'Country', 'Phone', 'Fax', 'HomePage') VALUES ('$CompanyName', '$ContactName', '$ContactTitle', '$Address', '$City', '$Region', '$PostalCode', '$Country', '$Phone', '$Fax', '$HomePage');");
    mysqli_close($con);
}
?>
<!doctype html>
